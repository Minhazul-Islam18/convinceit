        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="mb-4 d-flex justify-content-between align-items-center">
              ...
              <a href="{{ route('post-category.create')}}" target="_blank" rel="noopener noreferrer"><button type="button" class="btn btn-gradient-success btn-fw">Add Category</button></a> </div>
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr class="table-info">
                  ...
                  <td> May 15, 2015 </td>
                  <td>
                    <a href="{{ route('post-category.edit', $category -> id)}}" class="btn btn-gradient-primary btn-fw">EDIT</a>
                    <form action="{{ route('post-category.destroy',[$category -> id])}}" method="POST">
                    @method('DELETE')
                    @csrf
