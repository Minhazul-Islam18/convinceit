        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="mb-4 d-flex justify-content-between align-items-center">
              ...
              <a href="{{ route('g_category.create')}}" target="_blank" rel="noopener noreferrer"><button type="button" class="btn btn-gradient-success btn-fw">Add Category</button></a> </div>
              ...
              <tbody>
                ...
                <tr class="table-info">
                  ...
                  <td>
                    ...
                    <form action="{{ route('g_category.destroy',[$g_category -> id])}}" method="POST">
                    @method('DELETE')
                    @csrf
