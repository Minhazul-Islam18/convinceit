...
<div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        ...
        <p class="alert-class alert-success">{{$graphicportfolio -> name}}</p>
            ...
            <div class="row">
                <div class="col-md-12 stretch-card">
                    ...
                    <div class="card-body">
                      ...
                      @endif
                        <form class="forms-sample" action="{{ route('graphicportfolio.update',[$graphicportfolio->id])}}" method="POST" enctype="multipart/form-data">
                            @csrf
