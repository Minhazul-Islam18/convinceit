...
<div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        ...
        <p class="alert-class alert-success">{{$wportfolio -> name}}</p>
            ...
            <div class="row">
                <div class="col-md-12 stretch-card">
                    ...
                    <div class="card-body">
                      ...
                      @endif
                        <form class="forms-sample" action="{{ route('wportfolio.update',[$wportfolio->id])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="form-group row">
                          <label for="client" class="col-sm-3 col-form-label">
                            Client Name:</label>
                          <div class="col-sm-9">
                          <input name="client" type="text" class="form-control" id="title" placeholder="Post Title">
                          </div>
                      </div>
                      <div class="form-group row">
                          <label for="project_date" class="col-sm-3 col-form-label">
                            Project Date:</label>
                          <div class="col-sm-9">
                          <input name="project_date" type="text" class="form-control" id="title" placeholder="Post Title">
                          </div>
                      </div>
                      <div class="form-group row">
