        ...
        value: function initEvents() {
          ...
          window.addEventListener("load", function () {
            ...
            setTimeout(function () {
              ...
              (0,
              _objectFitImages2.default)(".widget_atail_recent_posts_widget img");
            }, 0);
          });
    ...
    _createClass(Navigation, [
      {
        ...
        value: function init() {
          ...
          var navList = (self.navList = document.querySelector(
            ".nav-list"
          ));
          if (!navList) {
            return false;
          ...
          this.showNavBtn = document.querySelector(
      ...
      },
      {
        ...
        value: function _hideExcessives() {
          ...
          var remnant = (self.remnant = [].slice.call(
            self.navListli,
            maxLength - 1
          ));
    ...
    _createClass(ProjectPreview, [
      {
        ...
        value: function init() {
          ...
          var projectPreview = (this.projectPreview = document.querySelector(
            ".project-preview"
          ));
          if (!projectPreview) {
            return false;
          ...
          var projectsImagesBox = (this.projectsImagesBox = document.querySelector(
            ".preview-images-item"
          ));
          this.projectsImages = [];
          this.fullPostSliderImages = [];
          ...
          if (this.projectsImages) {
            this.projectsImages[0] &&
              this.projectsImages[0].classList.add("images-item-active");
          }
            ...
            if (_this2.hasScroll) {
              (function () {
                ...
                if (projectView.scrollTop === 0 && delta < 0) {
                  ...
                  projectView.scrollTop >= _this2.maxScrollHeight &&
                  delta > 0
                ) {
                  goNext = true;
                } else {
                  ...
                  (0, _jsAnimation.jsAnimation)({
                    ...
                    draw: function draw(progress) {
                      projectView.scrollTop =
                        _this2.startPosition + _this2.path * progress;

                      if (_global2.default.ww >= 992) {
                        var top =
                          (_this2.startPosition + _this2.path * progress) *
                          _this2.scroll.precent;

                        if (top < 0) {
                          top = 0;
                        } else if (
                          top >
                          projectView.clientHeight -
                            _this2.scroll.lineHeight
                        ) {
                          top =
                            projectView.clientHeight -
                            _this2.scroll.lineHeight;
        ...
        value: function onKeyPress() {
          ...
          this.projectPreview.addEventListener("keydown", function () {
            ...
            if (_this3.hasScroll) {
              ...
              showNext =
                _this3.projectPreview.scrollTop >= _this3.maxScrollHeight;
            }
          });
      ...
      },
      {
        ...
        value: function onTouch() {
          ...
          // touch start
          this.projectPreview.addEventListener("touchstart", function (
            event
          ) {
            ...
            if (_this4.hasScroll) {
              ...
              showNext =
                _this4.projectPreview.scrollTop === _this4.maxScrollHeight;
            }
          ...
          // touch move
          this.projectPreview.addEventListener("touchmove", function (
            event
          ) {
            if (_this4.isAnimating) {
              return false;
      ...
      },
      {
        ...
        value: function showProject() {
          ...
          if (!_animationSupport.animationSupport) {
            ...
            images[prev] &&
              images[prev].classList.remove("images-item-active");
            images[current] &&
              images[current].classList.add("images-item-active");
          ...
          this.projects[this.prevProjectIndex].classList.add(
            "projects-count-hide"
          );

          this.projects[this.prevProjectIndex].classList.remove(
      ...
      },
      {
        ...
        value: function animateBoxBot() {
          ...
          var animateBoxBot = (this.animateBoxBot = document.createElement(
            "DIV"
          ));
          var animateBoxTop = (this.animateBoxTop = document.createElement(
            "DIV"
          ));
          var animateWrap = (this.animateWrap = document.createElement(
            "DIV"
          ));
          ...
          animateBoxBot.addEventListener(
            _transitionEvent.transitionEvent,
            animate
          );
          animateBoxTop.addEventListener(
            _transitionEvent.transitionEvent,
            animate
          );
        }
      },
      {
        ...
        value: function openFullPost(target) {
          ...
          (0, _promiseAjax.httpGet)(
            "jsons/atail_get_popup_project/",
            target
          )
            .then(
              function (result) {
            ...
            .then(function (result) {
              ...
              var cloneImage =
                _this6.projectsImages[_this6.currentProjectIndex] &&
                _this6.projectsImages[_this6.currentProjectIndex].cloneNode(
                  true
                );
              ...
              result.slides &&
                result.slides.forEach(function (item) {
                  var type = item.type;
                  ...
                  if (type === "image") {
                    (function () {
                      ...
                      if (fit === "full") {
                        _this6.scrollItem.push(
                          new _scroll2.default(scrollDiv)
                        );
                      }
                    })();
                  } else if (type === "video") {
              ...
              if (
                _this6.fullPostSliderImages &&
                _this6.fullPostSliderImages.length > 0
              ) {
                ...
                if (_this6.fullPostSliderImages.length > 1) {
                  ...
                  _this6.postSliderImages.appendChild(
                    _this6.fullPostNextSlide
                  );
                  _this6.postSliderImages.appendChild(
                    _this6.fullPostPrevSlide
                  );
                }
              }
              ...
              _this6.contentHeader.innerHTML =
                "<h4>" +
                result.title +
                "</h4>" +
                startDate +
              ...
              var footerString = result.positions
                ? result.participants
                : "";
        ...
        value: function closeFullPost() {
          ...
          if (!_animationSupport.animationSupport) {
            ...
            while (this.postSliderImages.firstChild) {
              this.postSliderImages.removeChild(
                this.postSliderImages.firstChild
              );
            }
      ...
      },
      {
        ...
        value: function createFullPost() {
          ...
          // блок для слайдера
          var slider = (this.fullPostSlider = document.createElement(
            "DIV"
          ));
          slider.className = "full-post-slider col-xs-10";
          // блок для елементів
          var images = (this.postSliderImages = document.createElement(
            "DIV"
          ));
          ...
          this.fullPostNextSlide.setAttribute(
            "data-action",
          ...
          this.fullPostPrevSlide.setAttribute(
            "data-action",
            "full-post-prev-slide"
          );
          this.fullPostPrevSlide.innerHTML = arrowTemplate;

          var content = (this.fullPostContent = document.createElement(
            "DIV"
          ));
          content.className = "full-post-content col-xs-2";
          var contentTableWrapper = (this.contentTableWrapper = document.createElement(
            "DIV"
          ));
          contentTableWrapper.className = "post-content-table-wrapper";
          var contentTable = (this.contentTable = document.createElement(
            "DIV"
          ));
          contentTable.className = "post-content-table";
          var contentHeader = (this.contentHeader = document.createElement(
            "DIV"
          ));
          contentHeader.className = "post-content-header";
          var contentFooter = (this.contentFooter = document.createElement(
            "DIV"
          ));
          ...
          var mobileMenuCloseBtn = (this.mobileMenuCloseBtn = document.createElement(
            "SPAN"
          ));
          mobileMenuCloseBtn.className = "mobile-menu-close-btn";
          mobileMenuCloseBtn.setAttribute(
            "data-action",
            "full-post-show-info"
          );
          ...
          var animatePost = function animatePost() {
            ...
            // проект відкритий
              ...
              _this7.fullPost.classList.contains("show-post-content")
            ) {
              // create scroll for full post content
              if (!_this7.scrollItemIsInited) {
                _this7.scrollItemIsInited = true;
                _this7.scrollItem.push(
                  new _scroll2.default(_this7.contentTableWrapper)
                );
                initScrollItem();
          ...
          var fullPostAnimateBox = (this.fullPostAnimateBox = document.createElement(
            "DIV"
          ));
          var animateBoxRight = (this.animateBoxRight = document.createElement(
            "DIV"
          ));
          var animateBoxLeft = (this.animateBoxLeft = document.createElement(
            "DIV"
          ));
          ...
          var animateBox = function animateBox() {
            if (
              _this7.fullPostAnimateBox.classList.contains("from-right")
            ) {
              if (
                _this7.fullPostAnimateBox.classList.contains(
                  "from-right-end"
                )
              ) {
                _this7.fullPostAnimateBox.classList.remove(
                  "from-right-end"
                );
                _this7.fullPostAnimateBox.classList.remove("from-right");
              } else {
                _this7.fullPostSliderImages[
                  _this7.fullPostCurrentIndex
                ].classList.add("active");
                _this7.fullPostSliderImages[
                  _this7.fullPostPrevIndex
                ].classList.remove("active");

                _this7.fullPostAnimateBox.classList.add("from-right-end");
              }
            } else if (
              _this7.fullPostAnimateBox.classList.contains("from-left")
            ) {
              if (
                _this7.fullPostAnimateBox.classList.contains(
                  "from-left-end"
          ...
          animateBoxRight.addEventListener(
            _transitionEvent.transitionEvent,
            animateBox
          );
          animateBoxLeft.addEventListener(
            _transitionEvent.transitionEvent,
            animateBox
          );
      ...
      },
      {
        ...
        value: function resize() {
          ...
          this.fullPost.style.width =
            _global2.default.main.offsetWidth + "px";
      ...
      },
      {
        ...
        value: function createShares(url, text) {
          ...
          var shareArray = JSON.parse(
            document.body.getAttribute("data-share")
          );
...
/***/ function (module, exports, __webpack_require__) {
  ...
  function httpGet(url, target) {
    ...
    return new _es6Promise.Promise(function (resolve, reject) {
      ...
      xhr.open(
        "GET",
        url + file + "?nochashe=" + new Date().getTime(),
        true
      );
...
/***/ function (module, exports, __webpack_require__) {
  ...
  /* WEBPACK VAR INJECTION */ (function (process, global, module) {
    ...
    (function () {
      ...
      var lib$es6$promise$$internal$$PROMISE_ID = Math.random()
        .toString(36)
        .substring(16);
      ...
      function lib$es6$promise$$internal$$makePromise(promise) {
        promise[
          lib$es6$promise$$internal$$PROMISE_ID
        ] = lib$es6$promise$$internal$$id++;
    ...
    */
      function lib$es6$promise$promise$$Promise(resolver) {
        this[
          lib$es6$promise$$internal$$PROMISE_ID
        ] = lib$es6$promise$$internal$$nextId();
    ...
    */
      ...
      lib$es6$promise$enumerator$$Enumerator.prototype._enumerate = function () {
        ...
        for (
          var i = 0;
          this._state === lib$es6$promise$$internal$$PENDING && i < length;
          i++
        ) {
...
/***/ function (module, exports) {
  ...
  var ಠ =
    "data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="; // transparent image, used as accessor and replacing image
    ...
    if (/scale-down/.test(style["object-fit"])) {
      ...
      (function loop() {
        ...
        if (el[ಠ].i.naturalWidth) {
          if (
            el[ಠ].i.naturalWidth > el.width ||
            el[ಠ].i.naturalHeight > el.height
          ) {
  ...
  var AtailScroll = (function () {
    function AtailScroll(boxWithScroll) {
      ...
      if (this.box.classList.contains("all-atail-projects")) {
        ...
        this.box.classList.contains("post-content-table-wrapper")
      ) {
    ...
    _createClass(AtailScroll, [
      ...
      },
      {
        ...
        value: function createScroll() {
          ...
          var scrollLine = (this.scrollLine = document.createElement(
            "SPAN"
          ));
          ...
          var onMouseMove = function onMouseMove(event) {
            ...
            _this.box.scrollTop =
              _this.currentScrollTop + result / _this.precent;
...
/***/ function (module, exports, __webpack_require__) {
  ...
  var Preloader = (function () {
    function Preloader() {
      ...
      var preloaderWrap = (this.preloaderWrap = document.querySelector(
      ...
      var preloader = (this.preloader = preloaderWrap.querySelector(
        ".atail-preloader"
      ));
    ...
    _createClass(Preloader, [
              ...
              [].forEach.call(images, function (img) {
                ...
                image.onload = function () {
                  ...
                  if (iteration === length) {
                    ...
                    if (!_animationSupport.animationSupport) {
                      _this2.preloader.classList.add(
                        "atail-preloader-loaded"
                      );
                      // GlobalVariables.atailMain.style.opacity = 1;
                      _global2.default.atailMain.classList.add(
                        "atail-opacity-1"
                      );
                    }
                  } else {
      ...
      },
      {
        ...
        value: function showAtail() {
          ...
          setTimeout(function () {
            if (
              !_this3.preloader.classList.contains("atail-preloader-loaded")
            ) {
    ...
    _createClass(AllProjects, [
      {
        ...
        value: function init() {
          ...
          var allProjects = (this.allProjects = document.querySelector(
            ".all-atail-projects"
          ));
          ...
          this.atailProjectsParent = document.querySelector(
            ".all-atail-projects-wrapper"
          );

          var allProjectsArray = (this.allProjectsArray = allProjects.querySelectorAll(
          ...
          this.currentCategoryArray = [].slice.call(
            this.allProjectsArray,
            0
          );
          this.projectsCategoryWrapper = this.currentCategoryArray[0].parentNode;

          var allProjectsLength = (this.allProjectsLength =
            allProjectsArray.length);

          this.projectCategory = document.querySelector(
          ...
          this.projectCategory.style.cssText =
            "width: " +
            _global2.default.mainClientWidth * precent +
            "px; right: " +
            ((_global2.default.ww - _global2.default.atailMainClientWidth) /
              2 +
              sideWidth) +
            "px";

          this.categoryWrapper = this.projectCategory.querySelector(
            ".all-atail-projects-category-wrapper"
          );
          this.projectsCategoryWrapperScroll = new _scroll2.default(
          ...
          var animateBox = (this.animateBox = document.createElement(
            "DIV"
          ));
          animateBox.className = "all-projects-animate-box";
          animateBox.innerHTML =
            "<div></div><div></div><div></div><div></div><div></div>";

          _global2.default.sides
            .querySelector("div")
            .appendChild(animateBox);
          animateBox.addEventListener(
            _transitionEvent.transitionEvent,
            this.categoryAnimating.bind(this)
          );

          this.isInit = true;

          this.currentTarget = this.projectCategory.querySelector(
            '.active[data-action="show-category"]'
          );
      ...
      },
      {
        ...
        value: function onScroll(scrollTop) {
          ...
          var height = scrollTop + _global2.default.wh * 0.85,
      ...
      },
      {
        ...
        value: function showCategory(target) {
          ...
          if (_animationSupport.animationSupport) {
            _global2.default.sides.classList.add(
          ...
          if (sides.classList.contains("all-projects-box-animating")) {
            if (sides.classList.contains("box-animating")) {
              ...
              (function () {
                ...
                [].forEach.call(_this2.currentCategoryArray, function (
                  item
                ) {
      ...
      },
      {
        ...
        value: function showProjects(target) {
          ...
          (0, _promiseAjax.httpGet)(
            "jsons/atail_get_all_projects/all_projects.html",
            target
          )
            .then(function (data) {
              ...
              // for ajax
              var closeProjectsBtn = (_this3.closeProjectsBtn = document.createElement(
                "DIV"
              ));
              closeProjectsBtn.className = "close-projects-btn";
              closeProjectsBtn.setAttribute(
                "data-action",
                "all-projects-close"
              );
              ...
              setTimeout(function () {
                ...
                _this3.closeProjectsBtn.classList.add(
                  "close-projects-btn-loaded"
                );

                var allProjects = _global2.default.main.querySelector(
                  ".all-atail-projects-wrapper"
                );
                ...
                setTimeout(function () {
                  ...
                  _this3.projectCategory.style.width =
                    _global2.default.main.clientWidth * precent + "px";
                  _this3.projectCategory.style.right =
                    (_global2.default.ww -
                      _global2.default.atailMain.clientWidth) /
                      2 +
                    sideWidth +
                    "px";
                }, 100);
      ...
      },
      {
        ...
        value: function closeProjects() {
          ...
          this.closeProjectsBtn.classList.remove(
            "close-projects-btn-loaded"
          );
          ...
          setTimeout(function () {
            ...
            setTimeout(function () {
              _global2.default.main.classList.remove(
        ...
        value: function resize() {
          ...
          this.timeOver = setTimeout(function () {
            ...
            setTimeout(function () {
              ...
              _this5.projectCategory.style.width =
                _global2.default.main.clientWidth * precent + "px";
              _this5.projectCategory.style.right =
                (_global2.default.ww -
                  _global2.default.atailMain.clientWidth) /
                  2 +
                sideWidth +
        ...
        value: function init() {
          ...
          [].forEach.call(forms, function (form) {
            form.onsubmit = function (event) {
              ...
              (0, _promiseAjax.httpPost)(
                _this.fileUrl,
                (0, _Serialize.form_serialize)(form),
                _this.action
              ).then(function (result) {
                result = JSON.parse(result);
  ...
  function blogPostLike(target) {
    wp.ajax.send("atail_add_like", {
      ...
      success: function success(data) {
        var template =
          '<i class="fa fa-heart-o" aria-hidden="true"></i>' + data.likes;
...
/***/ function (module, exports, __webpack_require__) {
  ...
  function blogPostDislike(target) {
    wp.ajax.send("atail_add_dislike", {
      ...
      success: function success(data) {
        var template =
          '<span class="comments-icon">&#207;</span>' + data.dislikes;
        target.innerHTML = template;
        (0, _setCookie.setCookie)("atail_xslt", data.token);
      },
      error: function error(data) {
    ...
    _createClass(Slider, [
      ...
      },
      {
        ...
        value: function createAnimateBox() {
          ...
          var sliderAnimateBox = (this.sliderAnimateBox = document.createElement(
            "DIV"
          ));
          var animateBoxRight = (this.animateBoxRight = document.createElement(
            "DIV"
          ...
          var animateBox = function animateBox(event) {
            ...
            if (_this2.sliderAnimateBox.classList.contains("from-right")) {
              if (
                _this2.sliderAnimateBox.classList.contains("from-right-end")
              ) {
                ...
                _this2.sliderItems[_this2.prevItem].classList.remove(
                  "active"
                );
                _this2.sliderItems[_this2.currentItem].classList.add(
                  "active"
                );
              ...
              _this2.sliderAnimateBox.classList.contains("from-left")
            ) {
              if (
                _this2.sliderAnimateBox.classList.contains("from-left-end")
              ) {
...
$(".pl").removeClass("cred");
$(this).addClass("cred");
$(this).toggleClass("projects-item-animate projects-count-hide");
var tpid = $(this).data("id");

$(".display-table").removeClass("projects-item-active projects-item-animate");

$("#" + tpid).addClass("projects-item-active projects-item-animate");
});
